          ...
          <?php
                  try {
                      ...
                      while ($consulta = $resultado -> fetch (PDO:: FETCH_ASSOC)){
                       ?>
                       <tr>
                           <th class="box2"><img src="../fotografiaProceso/<?=$consulta['foto_proceso']?>" title="<?=$consulta['foto_proceso']?>" width="100" height="100"></th>  
                           <th class="box2"> <?php echo $consulta['nombre_proceso'];?></th>
                           <th class="box2"> <?php echo $consulta['tipo_fer'];?></th>
                           <th class="box2"> <?php echo $consulta['fragancia_proceso'];?></th>
                           <th class="box2"> <?php echo $consulta['sabor_proceso'];?></th>   
                           <th class="box2"> <?php echo $consulta['acidez_proceso'];?></th>    
                           <th class="box2"> <?php echo $consulta['cuerpo_proceso'];?></th>                  
